(function($){
    ...
    var that = {
      init:function(pSystem){
        ...
        if (document.referrer.match(/echolalia|atlas|halfviz/)){
          // if we got here by hitting the back button in one of the blog, 
          // start with the blog section pre-selected
          that.switchSection('blog')
        }
      },
      resize:function(){
      ...
      _initMouseHandling:function(){
        ...
        var handler = {
          moved:function(e){
            ...
            }else if ($.inArray(nearest.node.name, ['shyal.com','code','algorithms','blog']) >=0 ){
  ...
  var Nav = function(elt){
    ...
    var that = {
      init:function(){
        ...
        $('#algorithms dl:not(.datastructure) dt').click(that.reveal)
        that.update()
        return that
      },
      more:function(e){
      ...
      update:function(){
        ...
        switch (_path){
          ...
          $('#algorithms').fadeTo('fast',0, function(){
            $(this).hide()
          ...
          $('#algorithms').stop(true).css({opacity:0}).show().delay(333).fadeTo('fast',1)
                    
          $('#algorithms').find(">div").hide()
          $('#algorithms').find('#'+_path).show()
  ...
  $(document).ready(function(){
    ...
    var theUI = {
      nodes:{"shyal.com":{color:"red", shape:"dot", alpha:1}, 
             blog:{color:CLR.branch, shape:"dot", alpha:1}, 
             pramp:{color:CLR.branch, shape:"dot", alpha:1}, 
             facebook:{color:CLR.branch, shape:"dot", alpha:1}, 
             pythonic:{color:CLR.branch, shape:"dot", alpha:1}, 
             halfviz:{color:CLR.demo, shape:"dot", alpha:1},
             atlas:{color:CLR.demo, alpha:0, link:'/atlas'},
             echolalia:{color:CLR.demo, alpha:0, link:'/echolalia'},

             algorithms:{color:CLR.branch, shape:"dot", alpha:1}, 
